...
# NEED TO CORRECT....SHOULD INCLUDE BEEP, NO BEEP, + UNDETERMINED (efe698...)
dead_detect = dead_detect %>%
  mutate(cwt_detection_method_id =
           if_else(cwt_detected %in% c("6242055f-b2bc-44c1-b0d4-3ce24be44bbe",          # Beep, no beep, undetermined
                                       "ba4209af-3839-46a7-bd5d-57bc8516f7af",
                                       "efe698a8-98dd-45df-ba5b-0d448c88121d"),
