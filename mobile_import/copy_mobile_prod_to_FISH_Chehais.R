#===============================================================================
# To allow comparison of initial mobile upload with final mobile upload
#
# Notes:
...
#  2. This script copies data from the initial upload in the prod FISH
#     DB to FISH_Chehalis to allow comparison of newly uploaded data
#     that shoud be correct, with the initial data that also includes
#     some manual editing.
#     Comparing the tables from FISH and FISH_Chehalis using an anti-join
#     at as time allows, should indicate which data have been changed
#     or manually edited.
#
#  Steps:
#  1. Delete existing mobile data in Fish_Chehalis...from final cumulative
#     upload.
#  2. Populate FISH_Chehalis with data from FISH on AWS prod. This will
#     preserve data initially uploaded and allow later comparison to
#     identify where data was manually edited.
#
#  Successfully transferred all mobile data from FISH prod to FISH_Chehalis
#  in local server on 2012-06-28 at ~ 8:40 AM
#
# AS 2021-06-28
#===============================================================================
...
# #==========================================================================================
# # Delete IFB cumulative upload data
# #==========================================================================================
#
# #======== redd data ===============
#
...
# Pull out location IDs: 6194 rows
loc_ids = unique(test_location_ids$location_id)
loc_ids = paste0(paste0("'", loc_ids, "'"), collapse = ", ")

# Get survey_event_ids....Some event data may have been added to surveys. 10574 rows
qry = glue("select survey_event_id ",
           "from spawning_ground.survey_event ",
           "where survey_id in ({s_ids})")
...
# location_coordinates: 6121 rows
db_con = pg_con_local("FISH_Chehalis")
...
db_con = pg_con_local(dbname = "FISH_Chehalis")
