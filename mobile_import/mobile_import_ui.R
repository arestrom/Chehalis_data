  ...
  fluidRow(
    column(
      ...
      tippy("<i style='color:#1a5e86;padding-left:8px', class='fas fa-info-circle'></i>",
            tooltip = glue("You will not be able to sync mobile data to the SG database ",
                           "until you have checked for new surveys and have verified that ",
                           "all streams and reaches are present. In other words, the ",
                           "'Missing streams' and 'Missing reaches' datasets below must ",
                           "both be empty after clicking on the 'Check for new surveys' ",
                           "button.")),
      br(),
      br(),
