...
CREATE TABLE location_error_correction_type_lut (
    location_error_correction_type_id text DEFAULT (CreateUUID()) PRIMARY KEY,
...
CREATE TABLE location_error_type_lut (
    location_error_type_id text DEFAULT (CreateUUID()) PRIMARY KEY,
...
CREATE TABLE location_source (
    location_source_id text DEFAULT (CreateUUID()) PRIMARY KEY,
    location_coordinates_id text NOT NULL,
    coordinate_capture_method_id text NOT NULL,
    location_error_type_id text NOT NULL,
    location_error_correction_type_id text NOT NULL,
    source_longitude decimal(14,9),
    source_latitude decimal(12,9),
    elevation_meter decimal(6,1),
    location_correction_layer_name text,
    waypoint_name text,
    waypoint_datetime text,
    comment_text text,
    created_datetime text DEFAULT (datetime('now')) NOT NULL,
    created_by text NOT NULL,
    modified_datetime text,
...
ALTER TABLE ONLY barrier_measurement_type_lut
    ADD CONSTRAINT pk_barrier_measurement_type_lut PRIMARY KEY (barrier_measurement_type_id);

ALTER TABLE ONLY barrier_type_lut
    ADD CONSTRAINT pk_barrier_type_lut PRIMARY KEY (barrier_type_id);
...
ALTER TABLE ONLY fish_barrier
    ADD CONSTRAINT fk_location__fish_barrier FOREIGN KEY (barrier_location_id) REFERENCES location(location_id);

ALTER TABLE ONLY fish_barrier
    ADD CONSTRAINT fk_barrier_measurement_type_lut__fish_barrier__height_type_id FOREIGN KEY (barrier_height_type_id) REFERENCES barrier_measurement_type_lut(barrier_measurement_type_id);

ALTER TABLE ONLY fish_barrier
    ADD CONSTRAINT fk_barrier_measurement_type_lut__fish_barrier__depth_type_id FOREIGN KEY (plunge_pool_depth_type_id) REFERENCES barrier_measurement_type_lut(barrier_measurement_type_id);

ALTER TABLE ONLY fish_barrier
    ADD CONSTRAINT fk_barrier_type_lut__fish_barrier FOREIGN KEY (barrier_type_id) REFERENCES barrier_type_lut(barrier_type_id);
...
--GRANT ALL ON DATABASE spawning_ground TO power_user;

--GRANT ALL ON DATABASE spawning_ground TO fish_program_admins;
