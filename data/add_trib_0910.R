...
# # Create new entry in waterbody_lut....Already exists no need to add
# wb = tibble(waterbody_id = remisc::get_uuid(1L),
#             waterbody_name = "Tributary 0910",
#             waterbody_display_name = "Tributary 0910 (23.0910)",
#             latitude_longitude_id = ll_id,
#             stream_catalog_code = "22.0910",
#             tributary_to_name = "NF Newaukum River",
#             obsolete_flag = 0L,
...
# Existing wb_id
existing_wb_id = "035298b6-7217-40c7-a447-6b268d3b308a"
...
stream_st = st_llid %>%
  ...
  mutate(waterbody_id = existing_wb_id) %>%
  mutate(gid = new_gid) %>%
...
# Existing wb_id
existing_wb_id = "e79a9944-d99f-48db-94fc-c1a69a2dfa2e"
...
# Use select into query to get data into point_location
qry = glue::glue("DELETE from stream where gid = {dup_gid}")
