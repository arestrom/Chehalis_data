...
# Edit and tested by AS 2020-09-15
#==================================================================
...
# dbPath = "C:\\data\\RStudio\\chehalis_data\\data\\R6_Spawning_Ground_Surveys.accdb"
...
r6_stream_surveys = iformr::get_all_records("wdfw",417821,3363255,
                                            fields = "fields", limit = 1000, 0, access_token, form_fields,0)
...
fields = glue::glue("id,parent_record_id,parent_page_id,parent_element_id,created_date,created_by,",
                    ...
                    "cwt_detected,cwt_label,dna_number,scale_card_number,",
...
# Pull data from iForm
r6_stream_surveys_deads = get_all_records("wdfw",417821,3363264,
                                          fields = "fields", limit = 1000, 0, access_token, form_fields,0)
...
# Pull data from iForm
r6_stream_surveys_lives = get_all_records("wdfw",417821,3363258,
                                          fields = "fields", limit = 1000, 0, access_token, form_fields,0)
...
# Pull data from iForm
r6_stream_surveys_other_observa = get_all_records("wdfw",417821,3363267,
                                                  fields = "fields", limit = 1000, 0, access_token, form_fields,0)
...
# Pull data from iForm
r6_stream_surveys_other_pics = get_all_records("wdfw",417821,3363270,
                                               fields = "fields", limit = 1000, 0, access_token, form_fields,0)
...
# Pull data from iForm
r6_stream_surveys_redds = get_all_records("wdfw",417821,3363261,
                                          fields = "fields", limit = 1000, 0, access_token, form_fields,0)
...
# Pull data from iForm
r6_tagged_carcass_recoveries = get_all_records("wdfw",417821,3363156,
                                               fields = "fields", limit = 1000, 0, access_token, form_fields,0)
...
# con <- odbcConnectAccess2007(dbPath)
# sqlSave(con, r6_stream_surveys,rownames = FALSE, append = TRUE)
# sqlSave(con, r6_stream_surveys_deads,table = "give_me_deads", rownames = FALSE)
# sqlSave(con, r6_stream_surveys_lives,rownames = FALSE, append = TRUE)
# sqlSave(con, r6_stream_surveys_other_observa,rownames = FALSE, append = TRUE)
# sqlSave(con, r6_stream_surveys_other_pics,rownames = FALSE, append = TRUE)
# sqlSave(con, r6_stream_surveys_redds,rownames = FALSE, append = TRUE)
